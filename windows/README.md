...
- Скролл наблюдается через Raw Input (`RIDEV_INPUTSINK`) — пассивно,
  вне цепочки доставки событий, системную мышь затормозить не может.
  Если регистрация не удастся, исчезнет только рулон бумаги.
